...
#define BSPCFN LT(SPACEFN, KC_BSPC)
...
[QWERTY] = LAYOUT(
           KC_ESC ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,KC_PSCR,KC_SCRL,KC_PAUS,KC_NUM ,QK_BOOT,
           KC_GRV ,KC_1   ,KC_2   ,KC_3   ,KC_4   ,KC_5   ,KC_6   ,KC_7   ,KC_8   ,KC_9   ,KC_0   ,KC_MINS,
           KC_TAB ,KC_Q   ,KC_W   ,KC_E   ,KC_R   ,KC_T   ,KC_Y   ,KC_U   ,KC_I   ,KC_O   ,KC_P   ,KC_LBRC,
           CTRLESC,KC_A   ,KC_S   ,KC_D   ,F_LT   ,KC_G   ,KC_H   ,KC_J   ,KC_K   ,KC_L   ,KC_SCLN,KC_QUOT,
           KC_LSFT,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_SLSH,KC_RSFT,
                   KC_NUBS,KC_NO  ,KC_NO  ,KC_NO          ,KC_EQL ,KC_RBRC,KC_NUHS,KC_NO  ,
                                           KC_LALT,KC_LGUI,KC_RCTL,KC_RALT,
                                                   KC_HOME,KC_PGUP,
                                   BSPCFN ,KC_DEL ,KC_END ,KC_PGDN,KC_ENT ,SPCFN
    ),
[FLAYER] = LAYOUT(
...
[SPACEFN] = LAYOUT(
           ...
           KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
           KC_GRV ,KC_1   ,KC_2   ,KC_3   ,KC_4   ,KC_5   ,KC_6   ,KC_7   ,KC_8   ,KC_9   ,KC_0   ,KC_MINS,
           KC_TRNS,KC_LS1 ,KC_LS2 ,KC_LS3 ,KC_LS4 ,KC_LS5 ,KC_LS6 ,KC_LS7 ,KC_LS8 ,KC_LS9 ,KC_LS0 ,KC_LSMI,
           KC_TRNS,KC_RA1 ,KC_RA2 ,KC_RA3 ,KC_RA4 ,KC_RA5 ,KC_RA6 ,KC_RA7 ,KC_RA8 ,KC_RA9 ,KC_RA0, KC_RAMI,
                   KC_RANU,KC_TRNS,KC_TRNS,KC_TRNS        ,KC_RAEQ,KC_RARB,KC_RANH,KC_TRNS,
                                           KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                                                   KC_TRNS,KC_TRNS,
                                   KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS
    ),
